...
public class Stage1Subsystem extends SubsystemBase {
    ...
    public Stage1Subsystem(final HardwareMap hmap, final String extensionLeft, final String extensionRight, final String angleUp, final String angleDown){
    ...
    public Stage1Subsystem(final HardwareMap hmap, final String extensionUp, final String extensionDown, final String angleLeft, final String angleRight, final double pAngle, final double iAngle, final double dAngle, final double fAngle, final double pExtend, final double iExtend, final double dExtend){
